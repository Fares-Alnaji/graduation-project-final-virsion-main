        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">{{ __('Products List') }}</span>
                ...
                <div class="card-toolbar">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                        ...
                        <div class="menu-item px-3 menu-state-bg-light-success">
                            <a href="{{ route('products.create') }}" class="menu-link px-3 bg-light-success"
                                style="color: green">{{ __('Create Product') }}</a>
                            <br>
                        </div>
                        <div class="menu-item px-3 menu-state-bg-light-danger">
                            <a href="{{ route('products.trash') }}" class="menu-link px-3 bg-light-danger"
                                style="color: red">{{ __('Trash') }}</a>
                            <br>
                        </div>
                        <div class="menu-item px-3">
                            <a href="{{ route('products.index') }}" class="menu-link px-3">{{ __('back') }}</a>
                            <br>
                        </div>
                    </div>
                    <!--end::Menu 2-->
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-125px">{{ __('Products Count') }}</th>
                        ...
                        <tbody>
                            @forelse ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#"
                                            class="text-info fw-bold text-hover-primary d-block mb-1 fs-6">{{ $product->category->name ?? ' --' }}</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                    ...
                                    <td>
                                        <a href="#"
                                            class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ $product->created_at }}</a>
                                    </td>
                                    <td class="text-end">
