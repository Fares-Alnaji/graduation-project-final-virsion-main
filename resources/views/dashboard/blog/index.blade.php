                ...
                <div class="card-toolbar">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                        ...
                        <div class="menu-item px-3 menu-state-bg-light-success">
                            <a href="{{ route('blogs.create') }}" class="menu-link px-3 bg-light-success"
                                style="color: green">{{ __('Create BLog') }}</a>
                            <br>
                        </div>

                        <div class="menu-item px-3">
                            <a href="{{ route('blogs.index') }}" class="menu-link px-3">{{ __('back') }}</a>
                            <br>
                        </div>
                    </div>
                    <!--end::Menu 2-->
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-125px">{{ __('Publish Date') }}</th>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label bg-light">
                                                    <img src="{{ asset('storage/' . $data->image) }}" class="h-100 w-100"
                                                        alt="">
                                                </span>
                                            </div>
