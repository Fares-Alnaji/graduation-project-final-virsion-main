            ...
            <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                        @canany(['Read-Admins', 'Create-Admin', 'Read-Roles', 'Create-Role', 'Read-Permissions'])
                            <span class="menu-link">
                                <span class="menu-icon">
                    ...
                    @endcanany
                    @canany(['Read-Sliders', 'Create-Slider'])
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen051.svg-->
                    ...
                    @endcanany
                    @canany(['Read-coupons', 'Create-coupon'])
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen051.svg-->
                    ...
                    <div class="menu-item menu-accordion mb-1">
                        <span class="menu-link">
                            ...
                            <span class="menu-title"><a href="{{ route('auth.logout') }}">
                                    {{ __('Logout') }}</a></span>
                        </span>
                    </div>
                </div>
