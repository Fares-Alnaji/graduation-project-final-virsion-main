    ...
    <div class="col-xl-12 ">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form  action="{{route('sliders.update' , $data->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    @method('put')
                    <x-alert/>
                    <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">{{__('Slider Name')}}</span>
                    ...
                    <div class="col">
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="description"class="form-control form-control-solid" id="" cols="30" value="" rows="10">{{ old('description') ?? $data->description }}</textarea>
                        </div>
                    </div>
