    ...
    <div class="col-xl-12 ">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form action="{{route('coupons.store')}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    <x-alert />
                    <!--begin::Input group-->
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">{{__('Coupon Name')}}</span>
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-solid" name="discount" id="discount" value="">
                        <!--end::Input-->
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="date" class="form-control form-control-solid" id="expiry_date" name="expiry_date"
