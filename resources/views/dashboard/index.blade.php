                                ...
                                <div class="card-p mt-n20 position-relative">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{ route('sliders.index') }}" class="text-danger fw-bold fs-6"><br>
                                        ...
                                        <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{ route('coupons.index') }}" class="text-success fw-bold fs-6"><br>
                                        ...
                                        <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{ route('blogs.index') }}" class="text-danger fw-bold fs-6"><br>
