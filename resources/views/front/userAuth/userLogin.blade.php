                        ...
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="#" class="signin-form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <label id="password" class="form-control-placeholder"
                                ...
                                <div class="form-group">
                                    <button type="button" onclick="login()"
                                        ...
                                        style="color: #c2a942;">Sign In</button>
                                </div>
                            ...
                            <p class="text-center">Not a member? <a href="{{ route('auth.userRegister') }}">Sign Up</a>
                            </p>
                        </div>
                    </div>
                </div>
