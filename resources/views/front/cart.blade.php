                                ...
                                @auth('web')
                                    @if ($cart)
                                        @foreach ($cart['items'] as $item)
                                            <tr class="text-center">
                                                <td>
                                                    <form action="{{ route('cart.delete', $item['object']->id) }}"
                                                        method="POST" style="border: none !important;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn">
                                                            <svg viewBox="0 0 15 17.5" height="14" width="11.5"
                                                ...
                                                <td class="image-prod h-20px w-20px">
                                                    <img class="img-fluid" style="width: 100px ; height: 100px;"
                                                        src={{ asset('storage/' . $item['object']->image) }}
