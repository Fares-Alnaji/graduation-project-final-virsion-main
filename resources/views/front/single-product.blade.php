        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('home') }}">Home</a></span> <span>Shop</span>
                    </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{ asset('storage/' . $product->image) }}" class="image-popup prod-img-bg"><img
                            src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <p><a href="{{ route('add-to-cart', $product->id) }}" class="btn btn-black py-3 px-5 mr-2">Add to
                            Cart</a>
